...
@mark.parametrize(
    ...
    [
        (
            ...
            raises(
                TypeError,
                match="Cannot contain non-OpenSCAD expression “1” of type <class 'int'>.",
            ),
        ),
        (
            'two_unknown',
            ...
            raises(
                TypeError,
                match="Cannot contain non-OpenSCAD expression “1” of type <class 'str'>.",
            ),
        ),
        (
            'trailing_unknown',
            ...
            raises(
                TypeError,
                match="Cannot contain non-OpenSCAD expression “2” of type <class 'int'>.",
            ),
        ),
